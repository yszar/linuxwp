...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Logo', 'haoui'),
		'id' => 'logo_src',
		'desc' => __('Logo不会做？去君子不器（Junzibuqi.Com）留言求助！Logo 最大高：32px；建议尺寸：140*32px 格式：png', 'haoui'),
	...
	$options[] = array(
		...
		'id' => 'keywords',
		'std' => '君子不器（Junzibuqi.Com）,http://junzibuqi.com,君子不器,万事不求人,做最全面的自己',
	...
	$options[] = array(
		...
		'id' => 'description',
		'std' => __('君子不器（Junzibuqi.Com），万事不求人，做最全面的自己！', 'haoui'),
	...
	$options[] = array(
		...
		'id' => 'footer_seo',
		'std' => '<a href="'.site_url('/sitemap.xml').'">'.__('网站地图', 'haoui').'</a> - 本主题由<a href="http://junzibuqi.com">君子不器（Junzibuqi.Com）</a>分享！'."\n",
...
*/
	...
	$options[] = array(
		...
		'id' => 'post_copyright',
		'std' => __('未经君子不器（Junzibuqi.Com）允许，不得转载本站任何文章：', 'haoui'),
		'type' => 'text');
...
/*
	...
	$options[] = array(
		...
		'desc' => '建议20字内',
		'std' => '君子不器（Junzibuqi.Com），万事不求人，做最全面的自己！',
		'type' => 'text');
