...
function opshui_page() {
    ...
    <div id="opshui-metabox" class="metabox-holder">
	    <div id="opshui" class="postbox">
			...
			<iframe id="xiuxiu2" src="http://www.daqianduan.com/static/theme/xiu-13658.php" frameborder="0" style="display:none"></iframe>
		...
		<?php echo '<div class="opshui-sidebar"><div class="opshui-sidebar-widget"><a href="http://www.daqianduan.com" target="_blank"><img src="'.THEME_URI.'/options/assets/images/ui-02.jpg"></a></div><div class="opshui-sidebar-widget"><a href="http://www.alibaixiu.com" target="_blank"><img src="'.THEME_URI.'/options/assets/images/ui-01.jpg"></a></div></div>'; ?>
	</div>
